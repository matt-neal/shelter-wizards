...
function onLoad() {
  ...
  if (!isLocalhost) {
    return registerValidServiceWorker(workerUrl);
  }
  verifyServiceWorker(workerUrl);
...
function registerValidServiceWorker(workerUrl: string) {
...
function verifyServiceWorker(workerUrl: string) {
